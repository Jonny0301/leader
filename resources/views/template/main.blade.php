    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/barang" class="nav-link">Leader</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/candidate/show" class="nav-link">Approve</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/candidate/result" class="nav-link">Result</a>
                </li>
            </ul>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <a href="/candidate/show" class="nav-link">
                                <i class="nav-icon fa-solid fa-address-book"></i>
                                <p>
                                    Approve
                                </p>
                            </a>
                            <a href="/candidate/result" class="nav-link">
